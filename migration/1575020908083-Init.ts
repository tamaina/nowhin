...
export class Init1575020908083 implements MigrationInterface {
    name = 'Init1575020908083'
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "person" ("id" character varying(16) NOT NULL, "createdAt" TIMESTAMP NOT NULL, "name" character varying(128) NOT NULL, "position" character varying(128) NOT NULL, "companyId" character varying(16) NOT NULL, CONSTRAINT "PK_5fdaf670315c4b7e70cce85daa3" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" character varying(16) NOT NULL, "createdAt" TIMESTAMP NOT NULL, "orderedAt" TIMESTAMP, "deliveredAt" TIMESTAMP, "workId" character varying(16) NOT NULL, "quantity" integer NOT NULL DEFAULT 1, "unitPrice" integer NOT NULL, "salesTaxIsInPrice" boolean NOT NULL, "salesTax" integer NOT NULL DEFAULT 10, "state" character varying(16) NOT NULL, CONSTRAINT "REL_9c87578f9789fccf28eff93d63" UNIQUE ("workId"), CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`, undefined);
